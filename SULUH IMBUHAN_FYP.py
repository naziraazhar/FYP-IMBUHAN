...
page4_frame = tk.Frame(root, bg='#98AFC7')
...
go_to_page4_button = tk.Button(page3_frame, text="Selesai", command=show_page4,
...
go_to_page4_button.pack(pady=10)
...
Jika perkataan warna biru bermaksud perkataan itu merupakan kata terbitan yang betul 
manakala jika perkataan warna merah bermaksud perkataan tersebut mempunyai penggunaan imbuhan yang salah
Imbuhan yang diperiksa adalah imbuhan awalan, imbuhan apitan dan imbuhan akhiran.
...
page4_label = tk.Label(page4_frame, text="TERIMA KASIH", font=("Helvetica", 20), fg="white", bg='#98AFC7')
page4_description = tk.Label(page4_frame, text="Terima Kasih Menggunakan Perisian Ini.", font=("Optima", 14),
                             fg="white", bg='#98AFC7')
page4_description2 = tk.Label(page4_frame, text="Diharapkan perisian ini dapat memberi manfaat kepada semua.", font=("Optima", 14),
                             fg="white", bg='#98AFC7')
page4_description3 = tk.Label(page4_frame, text="Daripada:Nazira", font=("Optima", 10),
                             fg="white", bg='#98AFC7')

page4_label.pack(pady=20)
page4_description.pack(pady=10)
page4_description2.pack(pady=10)
page4_description3.pack(pady=10)
